...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'supp.mardizu@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'PT.Mardizu Sejahtera'; // Isikan dengan nama pengirim
    protected $password = 'cbdmardizu01'; // Isikan dengan password email pengirim
